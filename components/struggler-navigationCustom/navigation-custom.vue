	...
	<view class="navigation-bar" :style="{height:height}">
		<view class="navigation-bar-fixed" :style="{height:height,background:(!config.transparent&&!config.linear)?config.bgcolor:'transparent'}">
			...
			<view v-if="[1,2].indexOf(config.type)!= -1" :class="config.type==1?'navigation-bar-capsule':'navigation-bar-textbox'" :style="{top:marginTop}">
				<view class="button-action button-action button-action-fix" hover-class="button-action-active" @click="back_">
					<image src="../../static/icon/back_.png" class="button_back" mode=""></image>
				</view>
				<view class="button-v-line"></view>
				<view v-if="!config.share" class="button-action" hover-class="button-action-active" @click="home_">
					<image src="../../static/icon/home_.png" mode="" class="button_home"></image>
				</view>
...
<style lang="scss">
	.button_back{
		// width:calc(48upx*0.8)!important;
		// height:calc(48upx*0.8)!important;
		width:48upx!important;
		height:48upx!important;
		padding:0upx!important
	}
	.button_home{
		// width:calc(52upx*0.8)!important;
		// height:calc(48upx*0.8)!important;
