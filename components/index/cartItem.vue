...
<!-- 			{{ item.content }} -->
		...
		<view class="tool" @click.stop="selectHandler">
			<view class="time">{{ item.create_time | formatTime }}</view>
			<view class="arrow"><view class="aritem" v-for="(item, index) in 3" :index="index" :key="index"></view></view>
		</view>
