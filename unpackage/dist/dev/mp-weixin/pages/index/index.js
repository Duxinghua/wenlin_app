...
var _index = _interopRequireDefault(__webpack_require__(/*! ./pages/index/index.vue */ 58));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
  ...
  methods: {
    ...
    getList: function getList(ismore) {var _this2 = this;
      ...
      if (this.navindex == 0) {
        ...
        this.$u.api.communityactivityGetList(data).then(function (result) {
          _this2.total = result.total;
          if (ismore) {
            _this2.list = _this2.list.concat(result.list);
          } else {
    ...
    delHandler: function delHandler(id) {var _this3 = this;
      if (this.navindex == 0) {
        this.$u.api.illegalstopDelete({ id: id }).then(function (result) {
          _this3.$u.toast('删除成功');
          setTimeout(function () {
            _this3.total = 0;
            _this3.page = 1;
        ...
        this.$u.api.noticesdelete({ id: id }).then(function (result) {
          _this3.$u.toast('删除成功');
          setTimeout(function () {
            _this3.total = 0;
            _this3.page = 1;
        ...
        this.$u.api.communityactivitydelete({ id: id }).then(function (result) {
          _this3.$u.toast('删除成功');
          setTimeout(function () {
            _this3.total = 0;
            _this3.page = 1;
